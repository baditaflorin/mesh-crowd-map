...
[![pages](https://img.shields.io/badge/live-baditaflorin.github.io%2Fmesh-crowd-map-f59e0b)](https://baditaflorin.github.io/mesh-crowd-map/)
[![version](https://img.shields.io/badge/version-0.1.0-blue)](https://github.com/baditaflorin/mesh-crowd-map/blob/main/package.json)
[![license](https://img.shields.io/badge/license-MIT-green)](./LICENSE)

> A privacy-safe shared board for coarse, short-lived observations.

**Live → https://baditaflorin.github.io/mesh-crowd-map/**

**Source → https://github.com/baditaflorin/mesh-crowd-map**
...
`mesh-crowd-map` lets a room share temporary observations without creating a movement trail. Instead of a GPS or street map, contributors choose one of nine broad schematic areas and add a short, validated note. Every observation also appears in an accessible list—nothing depends on visually interpreting a map.

The app never requests geolocation, sends coordinates, loads map tiles, or stores a precise location. Shared pins expire after one hour and can be removed by any room peer.

## Use it

1. Open the [live app](https://baditaflorin.github.io/mesh-crowd-map/) and share the room invite.
2. Add a display name, write a short observation, and choose a deliberately broad area.
3. Use the grid buttons or the full accessible list to review active observations.
4. Remove a stale observation, or let it expire automatically after one hour.
...
git clone https://github.com/baditaflorin/mesh-crowd-map
cd mesh-crowd-map
npm install
npm run dev
```
...
- `mesh-crowd-map:signalingUrl`
- `mesh-crowd-map:turnTokenUrl`
- `mesh-crowd-map:iceServers`
- `mesh-crowd-map:room`
